//variables
var blender, bread, egg, eggPack, femaleChef, flour, fridgeClose, fridgeOpen, pan;
var bg, maleChef, milk, stove, toaster, stovetop, island2, floor, book, openBook;
var blenderImg, breadImg, eggImg, eggPackImg, femaleChefImg, flourImg, fridgeCloseImg, fridgeOpenImg, panImg;
...
function preload(){
    ...
    panImg = loadImage("Images/fryingPan.png")
...
function setup(){
 ...
 //Createing sprites and objects
    ...
    //maleChef.addImage(maleChefImg);
     ...
     pan = createSprite(windowWidth/2-410, windowHeight/2+270, 90, 90)
     pan.addImage(panImg)
     pan.scale = 0.3
...
function pan1(){
    pan.x = windowWidth/2+200
    pan.y = windowHeight/2-50
   console.log("working 122")
}
function bookOpen(){
